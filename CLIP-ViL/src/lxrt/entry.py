...
from lxrt.side_transformers import SideConfig
from lxrt.lora import LoraConfig
...
class LXRTEncoder(nn.Module):
    def __init__(self, args, max_seq_length, mode='x'):
        ...
        if args.use_side_transformers:
            ...
            side_config.reduction_factor = args.reduction_factor
            side_config.detach_visual_projection = args.detach_visual_projection
            side_config.add_side_visual_projection = args.add_side_visual_projection
            side_config.encoder_side_layers = args.encoder_side_layers
        else:
            side_config = None
        ...
        if args.use_lora:
            ...
            lora_config.lora_dim = args.lora_dim
            lora_config.tasks = ["vqa"]
        else:
            lora_config = None
