...
def parse_args():
    ...
    parser.add_argument('--freeze_visual_projection', action="store_true")
    parser.add_argument('--detach_visual_projection', action="store_true")
    parser.add_argument('--add_side_visual_projection', action="store_true")
    parser.add_argument('--encoder_side_layers', type=str, default=None)

    # for lora
    parser.add_argument('--use_lora', action="store_true")
    parser.add_argument('--lora_dim', type=int, default=16)
    
    parser.add_argument('--compute_time', action="store_true")
