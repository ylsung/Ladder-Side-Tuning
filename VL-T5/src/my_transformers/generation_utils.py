    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            if "side_past_key_values" in model_kwargs:
                if model_kwargs["side_past_key_values"] is not None:
                    # Not NoneType or empty list
                    model_kwargs["side_past_key_values"] = self._reorder_cache(model_kwargs["side_past_key_values"], beam_idx)
