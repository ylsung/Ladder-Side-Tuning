...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--side_reduction_factor', type=int, default=8)
    parser.add_argument('--decoder_side_layers', type=str, default=None)
    ...
    # use bitfit
    parser.add_argument('--use_bitfit', action="store_true")
