...
do
    ...
    cp outputs/${config_name}/all_results.json  all_output_logs/t5-3b:side_transformers_bias_r${r}_g0_fisher_v2_e_d_${encoder_side_layers}_lr${lr}_$2@${seed}.json
done
done