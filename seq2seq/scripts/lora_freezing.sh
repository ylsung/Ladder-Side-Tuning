...
do
    ...
    python scripts/update_scripts_for_given_input.py configs/${file_name}.json task_adapter_layers_encoder eval ${encoder_list}
...
# freeze all layers in the encoder and # freeze some layers in the decoder
...
do
    ...
    python scripts/update_scripts_for_given_input.py configs/${file_name}.json task_adapter_layers_encoder eval '[]'
    python scripts/update_scripts_for_given_input.py configs/${file_name}.json trainable_encoder_layers eval '[]'

    python scripts/update_scripts_for_given_input.py configs/${file_name}.json task_adapter_layers_decoder eval ${decoder_list}
