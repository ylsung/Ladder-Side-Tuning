...
do
    ...
    python scripts/update_scripts_for_given_input.py configs/${config_name}.json merge_last str2bool True
    
    CUDA_VISIBLE_DEVICES=$1 python run_seq2seq.py  configs/${config_name}.json

    cp outputs/${config_name}/all_results.json  all_output_logs/side_tuning_lr${lr}_$2@${seed}.json
done